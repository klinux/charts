...
![Version: 12.2.1](https://img.shields.io/badge/Version-12.2.1-informational?style=flat-square) ![AppVersion: 15.2.0](https://img.shields.io/badge/AppVersion-15.2.0-informational?style=flat-square)
...
| image.tag | string | `"15.2.0-debian-11-r2"` |  |
| kubeVersion | string | `""` |  |
| ldap.basedn | string | `""` |  |
| ldap.binddn | string | `""` |  |
| ldap.bindpw | string | `""` |  |
...
| metrics.image.tag | string | `"0.11.1-debian-11-r60"` |  |
...
| volumePermissions.image.tag | string | `"11-debian-11-r86"` |  |
